...
namespace Game
{
    public class CameraControlSystems : IInitializable
    {
        ...
        public void Initialize()
        {
            ...
            {
                var container = _cameraStateMachine.GetStateDataContainer<LookAtBulletDataContainer>();
            ...
            _signalBus.GetStream<StartGameSignal>().Subscribe(signal =>
            {
                ...
                Vector3 sniperPosition = 
                    ...
                    ((targetSettings.TargetCubes.Length - 1 + 
                      targetSettings.WeighCenterCube * 0.5f) * Vector3.up) * currentLevel.SizeTargetElement;
                ...
                container.StartRotation = cameraTransform.rotation.eulerAngles;
                cameraTransform.position = sniperPosition;
