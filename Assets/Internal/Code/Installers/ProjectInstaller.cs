...
namespace Installers
{
    public class ProjectInstaller : MonoInstaller
    {
        ...
        [SerializeField] private DirectionsAppearanceBulletsAtMultiShot _directionsAppearanceBulletsAtMultiShot;
        ...
        private void CommonInstall()
        {
            ...
            Container.BindInstance(_directionsAppearanceBulletsAtMultiShot).AsSingle();
        }
    }
}